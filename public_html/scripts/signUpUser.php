...
if (mysqli_query($link, $query)) {
    ...
    $message = "Dear ".$firstName.",\r\n\r\nThank you for signing up to Edutix!\r\n\r\nPlease confirm your email address by visiting the link below:\r\nhttp://www.edutix.co.uk/eton/userSignUpPage/confirmEmail?id=".rawurlencode($emailConfirmationLink)."\r\n\r\nMany Thanks,\r\nThe Edutix Team";

    // send the email
    mail($_POST["emailInput"], 'Welcome to Edutix!', $message, "'From:hello@Edutix.co.uk' . '\r\n'");
