...
$userQuery = "UPDATE `".mysqli_real_escape_string($link, $_POST["db"])."` SET `eventName` = '".$eventName."', `eventDesc` = '".$eventDescription."', `eventLocation` = '".$eventLocation."', `eventDate` = '".$eventDate."', `eventHost` = '".$eventHost."', `isTicketed` = '".$isTicketed."' WHERE `id` = '".mysqli_real_escape_string($link, $_POST["eventID"])."' LIMIT 1";
